...
import { checkButtonTrigger, filterTrigger, formButtonTrigger, listStateTrigger, luzDestacadaTrigger, mostrandoStatusTrigger, semTarefasTrigger, shakeTrigger } from '../animations';
